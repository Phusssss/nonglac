...
const PostCard = ({ post, isDetailView = false, onCardClick, viewCount }) => {
  ...
  const isVerifiedSource = Boolean(post?.isAutoGenerated || post?.isAdminPost);
  const resolvedViewCount = Number(viewCount ?? post?.views ?? 0);
